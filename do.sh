...
opt-3.6 -load ./bin/Debug/libIndependentLoop.so -basicaa -mem2reg -simplifycfg -loop-simplify -loop-rotate -instcombine -indvars -indloop ./benchmark/c-ray/seq/c-ray-mt.ll -o /dev/null
